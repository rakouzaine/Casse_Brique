...
from Creation_brique import CreationBrique


from CreationBalle import CreationBalle

from MouvementPlatforme import MouvementPlateforme
...
class JeuCasseBrique:
    ...
    def game_loop(self):
        ...
        r = getattr(self.balle, "rayon", getattr(self.balle, "r", 8))
